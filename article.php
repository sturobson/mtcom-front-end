...
<body id="top" class="p-article">
  ...
  <div id="top" class="sg-header" role="banner">
    ...
    <div class="sg-wrapper sg-clearfix">
      <div id="nav" class="sg-sidebar" role="navigation">
        ...
        <div class="sg-nav-group sg-nav-group--pages">
          ...
          <ul class="sg-navlist" style="display:block;">
            ...
            <li><a style="color: #222;" href="./article.php">Article</a></li>
          </ul>
        </div>
      ...
      <!--end b-1-0-0-header-->
      <div class="b-main">
        <section class="b-expertise g-container">
          <article class="b-expertise__article-wrapper g-block">
            <div class="b-expertise__article g-row-wide">
              <div class="b-expertise__article-outer g-col">
                <div class="b-expertise__article-inner">
                  <header class="b-expertise__article-header">
                    <h3 class="b-expertise__article-title">&nbsp;</h3>
                  </header><!-- end "b-expertise__article-header" -->
                  <figure class="b-expertise__article-image b-expertise__article-image--hero">
                    &nbsp;
                  </figure><!-- end "b-expertise__article-image b-expertise__article-image-hero" -->
                  <div class="b-expertise__article-text">
                    &nbsp;
                  </div><!--end b-expertise__article-inner-->
                </div><!--end b-expertise__article-outer-->
              </div><!--end b-expertise__article-->
            </article><!-- end "b-expertise__article-wrapper g-block" -->

          </section><!-- end "b-expertise g-container" -->

          <div class="g-container b-expertise__article-download">

            <div class="b-button g-block">
              <div class="g-row">
                <div class="g-col">
                  <a href="#" class="b-button__item" title="">Download Case Study</a>
                </div>
              </div>
            </div>
