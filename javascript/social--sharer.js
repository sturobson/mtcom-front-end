...
(function ($) {
    ...
    var SelectionSharer = function (options) {
        ...
        this.show = function (e) {
            setTimeout(function () {
                ...
                if (!sel.isCollapsed && selection && selection.length > 10 && selection.match(/ /)) {
                    ...
                    var top = topOffset + scrollYvalue - self.$popover.height();
                    var left = 0;
                    if (e) {
                        left = e.pageX;
                    }
        ...
        this.shareEmail = function (e) {
            ...
            email.body = encodeURIComponent("“" + text + "”") + "%0D%0A%0D%0AFrom: " + pageTitle + "%0D%0A" + window.location.href;
        ...
        this.render = function () {
            var popoverHTML = '<div class="selectionSharer" id="selectionSharerPopover" style="position:absolute;">'
                             ...
                             + '      <li><a class="action email" href="" title="Share this selection by email" target="_self"></a></li>'
                             + '    </ul>'
                             + '  </div>'
            ...
            var popunderHTML = '<div id="selectionSharerPopunder" class="selectionSharer">'
                             ...
                             + '      <li><a class="action tweet" href="" title="Share this selection on Twitter" target="_blank">Tweet</a></li>'
                             + '      <li><a class="action facebook" href="" title="Share this selection on Facebook" target="_blank">Facebook</a></li>'
                             + '      <li><a class="action email" href="" title="Share this selection by email" target="_self"><svg width="20" height="20"><path stroke="#FFF" stroke-width="6" d="m16,25h82v60H16zl37,37q4,3 8,0l37-37M16,85l30-30m22,0 30,30"/></svg></a></li>'
                             + '    </ul>'
                             + '  </div>'
                             + '</div>';
